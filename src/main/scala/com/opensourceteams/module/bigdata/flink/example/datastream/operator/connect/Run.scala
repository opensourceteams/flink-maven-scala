package com.opensourceteams.module.bigdata.flink.example.datastream.operator.connect
...
object Run {
  ...
  def main(args: Array[String]): Unit = {
   ...
   val dataStream2 = getDataStream(env,12345,"localhost")
    ...
    dataStream3.keyBy(0,0)

        .map(new CoMapFunction[(String,Int),(String,Int),(String,Int)] {
          override def map1(value: (String, Int)): (String, Int) = (value._1,value._2)

          override def map2(value: (String, Int)): (String, Int) = (value._1,value._2)
        })
        .print()
